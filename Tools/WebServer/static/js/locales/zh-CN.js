...
window.i18nResources['zh-CN'] = {
  translation: {
    ...
    transfer: {
      ...
      folder_cancelled: '文件夹上传已取消',
      folder_progress: '文件夹：{{uploaded}}/{{total}} 个文件 ({{percent}}%)',
      folder_complete:
        '文件夹上传完成：{{name}}（{{uploaded}}/{{total}} 个文件，{{speed}}）',
      stat_loss: '丢包：{{rate}}%',
      stat_retries: '重试：{{count}}',
      stat_crc_errors: 'CRC 错误：{{count}}',
      upload_cancelled: '上传已取消：{{name}}',
      upload_complete: '上传完成：{{path}}{{speed}}{{stats}}',
      upload_failed_log: '上传失败：{{error}}',
      upload_error: '上传错误：{{error}}',
      starting_upload: '开始上传：{{name}} -> {{path}}',
      upload_file_failed: '上传失败 {{path}}：{{error}}',
      upload_file_error: '上传错误 {{path}}：{{error}}',
      select_files_download: '请选择要下载的文件',
      starting_download: '开始下载：{{path}}',
      downloading: '正在下载 {{name}}...',
      download_cancelled: '下载已取消：{{name}}',
      download_complete: '下载完成：{{name}}{{speed}}{{stats}}',
      download_failed_log: '下载失败：{{error}}',
      download_error: '下载错误：{{error}}',
      select_file_delete: '请选择要删除的文件',
      enter_dir_name: '请输入目录名称：',
      select_file_rename: '请选择要重命名的文件或目录',
      enter_new_name: '请输入新名称：',
      scanning_folder: '正在扫描文件夹：{{name}}...',
      folder_empty: '文件夹为空：{{name}}',
      found_files: '在 {{name}} 中找到 {{count}} 个文件',
