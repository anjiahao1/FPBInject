  ...
  translation: {
    ...
    config: {
      ...
      labels: {
        ...
        watch_dirs: '监视目录',
        upload_chunk_size: '上传块大小',
        download_chunk_size: '下载块大小',
        serial_tx_fragment_size: '发送分片大小',
        serial_tx_fragment_delay: '发送分片延迟',
    ...
    statusbar: {
      ...
      gdb_server: 'GDB :{{port}}',
      gdb_server_title: '外部 GDB RSP 服务器',
    },
    ...
    transfer: {
      ...
      download: '下载',
      loading: '加载中...',
      error_list: '错误：{{message}}',
      failed_to_list: '获取列表失败',
      no_files: '无文件',
      eta: '剩余：{{time}}',
      loss: '丢包：{{rate}}%',
      retries_count: '重试：{{count}}',
      not_connected_hint: '未连接到设备，请先连接。',
      uploading: '上传中...',
      uploading_folder: '上传文件夹：{{uploaded}}/{{total}} 个文件',
      folder_progress: '文件夹：{{uploaded}}/{{total}} 个文件 ({{percent}}%)',
      stat_loss: '丢包：{{rate}}%',
      stat_retries: '重试：{{count}}',
      stat_crc_errors: 'CRC 错误：{{count}}',
    ...
    tutorial: {
      ...
      // 门控提示
      gate_connection: '请在左侧连接设备',
      gate_connection_ok: '✅ 设备连接成功！',
      gate_device: '请点击「吞吐测试」按钮',
      gate_device_ok: '✅ 吞吐测试完成！',
      gate_transfer: '请点击「刷新」加载文件列表',
      ...
      hello_verify_desc: '发送命令验证注入是否生效。',
