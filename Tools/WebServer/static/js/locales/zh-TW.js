  ...
  translation: {
    ...
    config: {
      ...
      labels: {
        ...
        watch_dirs: '監視目錄',
        upload_chunk_size: '上傳區塊大小',
        download_chunk_size: '下載區塊大小',
        serial_tx_fragment_size: '傳送分片大小',
        serial_tx_fragment_delay: '傳送分片延遲',
    ...
    transfer: {
      ...
      download: '下載',
      loading: '載入中...',
      error_list: '錯誤：{{message}}',
      failed_to_list: '取得列表失敗',
      no_files: '無檔案',
      eta: '剩餘：{{time}}',
      loss: '遺失：{{rate}}%',
      retries_count: '重試：{{count}}',
      cancelled: '傳輸已取消',
      not_connected_hint: '未連線到裝置，請先連線。',
      not_connected: '未連線',
      uploading: '上傳中...',
      uploading_folder: '上傳資料夾：{{uploaded}}/{{total}} 個檔案',
      folder_cancelled: '資料夾上傳已取消',
      folder_progress: '資料夾：{{uploaded}}/{{total}} 個檔案 ({{percent}}%)',
      folder_complete:
        '資料夾上傳完成：{{name}}（{{uploaded}}/{{total}} 個檔案，{{speed}}）',
      stat_loss: '遺失：{{rate}}%',
      stat_retries: '重試：{{count}}',
      stat_crc_errors: 'CRC 錯誤：{{count}}',
      upload_cancelled: '上傳已取消：{{name}}',
      upload_complete: '上傳完成：{{path}}{{speed}}{{stats}}',
      upload_failed_log: '上傳失敗：{{error}}',
      upload_error: '上傳錯誤：{{error}}',
      starting_upload: '開始上傳：{{name}} -> {{path}}',
      upload_file_failed: '上傳失敗 {{path}}：{{error}}',
      upload_file_error: '上傳錯誤 {{path}}：{{error}}',
      select_files_download: '請選擇要下載的檔案',
      starting_download: '開始下載：{{path}}',
      downloading: '正在下載 {{name}}...',
      download_cancelled: '下載已取消：{{name}}',
      download_complete: '下載完成：{{name}}{{speed}}{{stats}}',
      download_failed_log: '下載失敗：{{error}}',
      download_error: '下載錯誤：{{error}}',
      select_file_delete: '請選擇要刪除的檔案',
      enter_dir_name: '請輸入目錄名稱：',
      select_file_rename: '請選擇要重新命名的檔案或目錄',
      enter_new_name: '請輸入新名稱：',
      scanning_folder: '正在掃描資料夾：{{name}}...',
      folder_empty: '資料夾為空：{{name}}',
      found_files: '在 {{name}} 中找到 {{count}} 個檔案',
