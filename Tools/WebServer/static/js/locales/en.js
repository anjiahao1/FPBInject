...
window.i18nResources['en'] = {
  translation: {
    ...
    transfer: {
      ...
      failed_to_list: 'Failed to list',
      no_files: 'No files',
      eta: 'ETA: {{time}}',
      loss: 'Loss: {{rate}}%',
      retries_count: 'Retries: {{count}}',
      cancelled: 'Transfer cancelled',
      not_connected_hint: 'Not connected to device. Please connect first.',
      not_connected: 'Not connected',
      uploading: 'Uploading...',
      uploading_folder: 'Uploading folder: {{uploaded}}/{{total}} files',
      folder_cancelled: 'Folder upload cancelled',
      folder_progress: 'Folder: {{uploaded}}/{{total}} files ({{percent}}%)',
      folder_complete:
        'Folder upload complete: {{name}} ({{uploaded}}/{{total}} files, {{speed}})',
      stat_loss: 'loss: {{rate}}%',
      stat_retries: 'retries: {{count}}',
      stat_crc_errors: 'CRC errors: {{count}}',
      upload_cancelled: 'Upload cancelled: {{name}}',
      upload_complete: 'Upload complete: {{path}}{{speed}}{{stats}}',
      upload_failed_log: 'Upload failed: {{error}}',
      upload_error: 'Upload error: {{error}}',
      starting_upload: 'Starting upload: {{name}} -> {{path}}',
      upload_file_failed: 'Failed to upload {{path}}: {{error}}',
      upload_file_error: 'Upload error for {{path}}: {{error}}',
      select_files_download: 'Please select file(s) to download',
      starting_download: 'Starting download: {{path}}',
      downloading: 'Downloading {{name}}...',
      download_cancelled: 'Download cancelled: {{name}}',
      download_complete: 'Download complete: {{name}}{{speed}}{{stats}}',
      download_failed_log: 'Download failed: {{error}}',
      download_error: 'Download error: {{error}}',
      select_file_delete: 'Please select a file to delete',
      enter_dir_name: 'Enter directory name:',
      select_file_rename: 'Please select a file or directory to rename',
      enter_new_name: 'Enter new name:',
      scanning_folder: 'Scanning folder: {{name}}...',
      folder_empty: 'Folder is empty: {{name}}',
      found_files: 'Found {{count}} files in {{name}}',
